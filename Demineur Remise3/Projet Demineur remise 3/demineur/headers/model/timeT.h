...
public:
    ...
    /**
     * @brief stopTimePassed
     *
     * This method allows to stop the timer and return her valor
     *
     * @return a unsigned who is the valor of the time when it stop
     *
     */
    unsigned stopTimePassed();
